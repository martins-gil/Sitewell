...
export function helpArticles(t: TFunction): HelpArticle[] {
  ...
  return [
    ...
    },
    {
      ...
      answer: t("The criteria download as a Word “Checklist for verification of inclusion and exclusion criteria” — the site's source document, with Yes / No / NA / Comments columns, the eligibility line and the investigator's signature and date."),
      steps: [
        t("For a visit: open the visit and press “Download I/E criteria form for this visit (.docx)” — the visit and patient are filled in, and the answers you recorded come ticked."),
        t("For a patient without a visit: open the patient and press “Download I/E criteria (.docx)” under the criteria."),
        t("For a blank form of the whole study: open the study and press “Download blank I/E form (.docx)”. Add the study's EU CT number on the study page so it prints in the footer."),
        t("Yes / No answers the criterion as written, so on an exclusion criterion “Yes” means it applies to the patient. NA, comments, eligibility and signature are left for the investigator."),
      ],
    ...
    },
    {
      ...
      steps: [
        t("Open Kits Inventory. The table at the top shows, for each study, how many kits are available, assigned, expired and used; the study and status filters narrow the list below it."),
        t("Press “Add kit”; enter a quantity to add several identical kits at once."),
        t("Assign a kit to a patient's visit: it is locked to that patient and no longer counts as available. Until the visit has taken place you can release it again."),
    ...
    },
    {
      id: "kit-stock",
      category: kits,
      question: t("What happens when I run out of kits?"),
      answer: t("When every kit of a study is assigned to patients, used or expired, an orange bar and an email every 3 days ask you to request more kits."),
      steps: [
        t("Request more kits from the sponsor or the supplier."),
        t("In Kits Inventory press “Mark as requested” on the study's row — that stops the bar and the emails."),
        t("When the kits arrive, add them with “Add kit”. The alert comes back the next time the stock runs out."),
      ],
      href: "/dashboard/kits",
      keywords: "stock out of kits none left available request restock reorder low",
    },
    {
      id: "lab-samples",
      category: kits,
      question: t("How do I record a shipment of laboratory samples?"),
      answer: t("Lab samples keeps one record per shipment: the airway bill (AWB), the date, and how many samples went ambient, refrigerated and frozen — optionally with the kits the samples were collected with."),
      steps: [
        t("Open Lab samples and choose the study, then enter the AWB and the date shipped."),
        t("Enter the number of ambient, refrigerated and frozen samples."),
        t("Tick the kits the samples were collected with (optional) and press “Add shipment”."),
        t("Use the study and date filters to list shipments; the totals at the top follow the filter."),
      ],
